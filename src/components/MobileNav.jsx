...
function MobileNav({ activeTab, setActiveTab }) {
  return (
    <nav className="fixed inset-x-0 bottom-0 border-t border-slate-200 bg-white/95 backdrop-blur-md shadow-2xl lg:hidden">
      <div className="mx-auto flex max-w-lg items-center justify-between px-4 py-3 text-xs font-semibold text-slate-500">
        {NAV_ITEMS.map((item) => {
